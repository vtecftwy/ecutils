# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs-dev/eda_stats_utils.ipynb.

# %% ../nbs-dev/eda_stats_utils.ipynb 2
...
# %% ../nbs-dev/eda_stats_utils.ipynb 3
...
# %% ../nbs-dev/eda_stats_utils.ipynb 4
...
# %% ../nbs-dev/eda_stats_utils.ipynb 5
def ecdf(data:pd.Series|np.array,            # data to analyse 
